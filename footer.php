...
<footer id="colophon" class="site-footer <?php if ( xbox_get_field_value( 'wpst-options', 'layout' ) == 'boxed' ) :
	...
	<div class="row">
		...
		<?php if ( xbox_get_field_value( 'wpst-options', 'logo-footer' ) == 'on' ) : ?>
			...
			?>
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" title="<?php echo get_bloginfo( 'name' ); ?>"><img class="grayscale" src="<?php if ( ! empty( $image_logo_file ) ) {	echo esc_url( $image_logo_file ); } elseif ( ! empty( $niche_image_logo_file ) ) { echo esc_url( get_template_directory_uri() . $niche_image_logo_file ); } ?>" alt="<?php echo get_bloginfo( 'name' ); ?>"></a>
			</div>
		<?php endif; ?>
...
if ( ! wp_is_mobile() && xbox_get_field_value( 'wpst-options', 'other-scripts' ) != '' ) {
	echo xbox_get_field_value( 'wpst-options', 'other-scripts' );
}
?>
...
if ( wp_is_mobile() && xbox_get_field_value( 'wpst-options', 'mobile-scripts' ) != '' ) {
	echo xbox_get_field_value( 'wpst-options', 'mobile-scripts' );
}
?>
