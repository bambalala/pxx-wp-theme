...
<div id="video-share">
	...
	<a target="_blank" href="https://twitter.com/share?url=<?php print $current_url;?>&text=<?php echo $current_desc;?>"><i id="twitter" class="fa fa-twitter"></i></a>
    <?php endif; ?>
    ...
    <?php if( xbox_get_field_value( 'wpst-options', 'reddit-video-share' ) == 'on' ) : ?>
		<a target="_blank" href="http://www.reddit.com/submit?title=<?php print $current_title;?>&url=<?php print $current_url;?>"><i id="reddit" class="fa fa-reddit-square"></i></a>
    <?php endif; ?>
