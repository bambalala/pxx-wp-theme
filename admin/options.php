...
function wpst_options() {
	...
	$xbox->add_main_tab(
		...
		$xbox->open_tab_item( 'niches' );
			$xbox->open_tab_item( 'import-theme-options' );
				$xbox->add_import_field(
					array(
						'name'    => 'Select a Niche',
						'default' => 'https://www.wp-script.com/niches-data/milf.json',
						'desc'    => 'Select a Niche, then click import button. Theme options will be imported in order to change the appearance of your site.',
						'items'   => array(
						...
						'options' => array(
							'import_from_file' => false, // Hide import from file.
							'import_from_url'  => false, // Hide import from url.
							'width'            => '300px',
						),
					)
				);
			$xbox->close_tab_item( 'import-theme-options' );
		...
		$xbox->open_tab_item( 'advertising' );
			...
			$xbox->add_field(
				array(
					...
					'desc'       => '<img src="' . get_template_directory_uri() . '/admin/assets/img/theme-options/header-happy-desktop.jpg">',
					'attributes' => array(
						'rows' => 6,
					),
				)
			...
			$xbox->add_field(
				array(
					...
					'desc'       => '<img src="' . get_template_directory_uri() . '/admin/assets/img/theme-options/sidebar-happy-desktop.jpg">',
					'attributes' => array(
						'rows' => 6,
					),
				)
