...
function set_default_theme_widgets ($old_theme, $WP_theme = null) {
    ...
    wpst_add_widget_theme_activation( 'homepage', 'text', 2, $home_2 );
    wpst_add_widget_theme_activation( 'homepage', 'widget_videos_block', 3, $home_3 );

    // wpst_add_widget_theme_activation( 'sidebar', 'categories', 6, $sidebar_1 );
    wpst_add_widget_theme_activation( 'sidebar', 'widget_videos_block', 4, $sidebar_2 );
    wpst_add_widget_theme_activation( 'sidebar', 'text', 5, $sidebar_3 );
    wpst_add_widget_theme_activation( 'sidebar', 'widget_videos_block', 6, $sidebar_4 );

    wpst_add_widget_theme_activation( 'footer', 'widget_videos_block', 7, $footer_1 );
    wpst_add_widget_theme_activation( 'footer', 'text', 8, $footer_2 );
    wpst_add_widget_theme_activation( 'footer', 'text', 9, $footer_3 );
    wpst_add_widget_theme_activation( 'footer', 'widget_videos_block', 10, $footer_4 );
